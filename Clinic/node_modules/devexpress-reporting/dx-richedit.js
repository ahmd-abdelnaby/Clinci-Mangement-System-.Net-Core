                    ...
                    (function (Internal) {
                        ...
                        var RichEditVirtualScroll = (function (_super) {
                            ...
                            RichEditVirtualScroll.prototype.registerViewPort = function (viewPort) {
                                ...
                                this._disposables.push({
                                    dispose: function () { return _this._viewPort.removeEventListener("scroll", updateRich); }
                                });
                            };
                            ...
                            RichEditVirtualScroll.prototype.updateRich = function (item, viewPortRect) {
                                ...
                                var currentScrollOffset = viewPortRect.top - elementRect.top;
                                var currentHeight = Math.min(elementRect.height, this._viewPort.clientHeight);
                                if (elementRect.top + elementRect.height < 0)
                                    currentHeight = 0;
                                if (elementRect.top > this._viewPort.clientHeight)
                                    currentHeight = 0;
                                var updateVirtualScroll = currentHeight != item.model._richHeight
                                    || currentHeight === this._viewPort.clientHeight;
                                if (updateVirtualScroll) {
                                    item.model._richHeight = currentHeight;
                                    item.model._verticalScrollOffset = currentScrollOffset;
                        ...
                        var XRRichEditControlModel = (function (_super) {
                            ...
                            XRRichEditControlModel.prototype.updateCanvasScroll = function () {
                                this._richEdit["_native"].core.viewManager.canvasListener.onCanvasScroll();
                            };
