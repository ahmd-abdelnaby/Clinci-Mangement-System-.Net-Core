...
(function (DevExpress) {
    ...
    (function (Analytics) {
        ...
        (function (Data) {
            ...
            var JsonParameter = (function (_super) {
                ...
                JsonParameter.prototype.getInfo = function () {
                    return [
                        ...
                        { propertyName: "itemType", modelName: "@ItemType", defaultVal: "PathParameter", alwaysSerialize: true }
                    ];
                };
            ...
            var parameterTypes = [
                { value: "PathParameter", displayValue: "Path Parameter", localizationId: "AnalyticsCoreStringId.JsonDSWizard_ChooseJsonSourcePage_PathParameter" },
                { value: "QueryParameter", displayValue: "Query Parameter", localizationId: "AnalyticsCoreStringId.JsonDSWizard_ChooseJsonSourcePage_QueryParameter" },
                { value: "Header", displayValue: "Header", localizationId: "AnalyticsCoreStringId.JsonDSWizard_ChooseJsonSourcePage_Header" }
            ];
            var JsonSource = (function (_super) {
                ...
                function JsonSource(model, serializer) {
                    ...
                    _this.queryParameters = Analytics.Utils.deserializeArray(model["QueryParameters"], function (item) { return new JsonParameter(item, serializer); });
                    _this.headers = Analytics.Utils.deserializeArray(model["Headers"], function (item) { return new JsonParameter(item, serializer); });
                    _this.pathParameters = Analytics.Utils.deserializeArray(model["PathParameters"], function (item) { return new JsonParameter(item, serializer); });
                    return _this;
                }
        ...
        (function (Wizard) {
            ...
            function _registerConfigureObjectDataSourceParametersPage(factory, getItemsProviderCallback) {
                factory.registerMetadata(Wizard.ObjectDataSourceWizardPageId.ConfigureParametersPage, {
                    ...
                    create: function () {
                        return new ConfigureObjectDataSourceParametersPage(getItemsProviderCallback());
                    },
            ...
            function _registerSpecifyJsonConnectionPage(factory, connections, allowCreateNewJsonConnection, getItemsProviderCallBack) {
                factory.registerMetadata(Wizard.JsonDataSourceWizardPageId.SpecifyJsonConnectionPage, {
                    create: function () { return new SpecifyJsonConnectionPage(connections, allowCreateNewJsonConnection, getItemsProviderCallBack()); },
            ...
            function _registerChooseJsonSourcePage(factory, requestWrapper, getItemsProviderCallback) {
                factory.registerMetadata(Wizard.JsonDataSourceWizardPageId.ChooseJsonSourcePage, {
                    ...
                    create: function () {
                        return new ChooseJsonSourcePage(requestWrapper, getItemsProviderCallback());
                    },
                ...
                var MultiQueryDataSourceWizard = (function (_super) {
                    ...
                    function MultiQueryDataSourceWizard(connectionStrings, wizardSettings, callbacks, disableCustomSql, rtl) {
                        ...
                        _this.steps = [
                            ...
                            new JsonDataSourceJsonSourcePage(_this, callbacks.getItemsProviderCallback()),
                    ...
                    JsonDataSourceJsonSourcePageUriSettings.prototype._getParametersInfo = function () {
                        ...
                        var parameters = {
                            ...
                            addHandler: function () {
                                ...
                                var jsonParameter = Data.JsonParameter.from({ "@Name": newName });
                                if (_this._itemsProvider)
                                    jsonParameter.itemsProvider = _this._itemsProvider;
                                return jsonParameter;
                            },
...
DevExpress.Analytics.Widgets.Internal.SvgTemplatesEngine.addTemplates({
    ...
    'dx-jsonwizard-parametercollection': '<div class="dx-field">        <!-- ko with: value -->        <div class="dx-jsonwizard-parameter-left-container">            <div class="dx-jsonwizard-parameter">                <div data-bind="dxLocalizedSelectBox: { dataSource: _parameterTypes, value: itemType, valueExpr:\'value\', displayExpr: \'displayValue\', displayCustomValue: true, dropDownOptions: { container: $root.getPopupContainer($element) } }"></div>            </div>        </div>        <div class="dx-jsonwizard-parameter-middle-container">            <div data-bind="dxTextBox: { value: name, placeholder: $data.namePlaceholder() }, dxValidator: { validationRules: $parent.editor.editorOptions.nameValidationRules || [] }"></div>        </div>        <div class="dx-jsonwizard-parameter-right-container">            <div class="dx-jsonwizard-parameter">                <div data-bind="dxTextBox: { value: _editingValue, placeholder: $data.valuePlaceholder() }, visible: !$data.isExpression()"></div>                <div data-bind="dxExpressionEditor: { options: _expression, fieldListProvider: itemsProvider, displayNameProvider: $root.displayNameProvider && $root.displayNameProvider() }, visible: $data.isExpression"></div>            </div>        </div>        <!-- ko template: { name: \'dx-wizard-menu-box-editorswitch\', data: $data } -->        <!-- /ko  -->        <!-- /ko -->    </div>',
