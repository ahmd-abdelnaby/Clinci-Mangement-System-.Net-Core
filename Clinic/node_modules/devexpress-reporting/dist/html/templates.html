...
<script type="text/html" id="dxrp-mobile-editing-field-image">
    ...
    <div class="dxrd-preview-search-wrapper" data-bind="visible: active() && visible()">
        ...
        <div class="dxrd-preview-search-result" data-bind="dxScrollView: { showScrollbar: 'onHover' }">
            ...
            <div class="dxrd-preview-search-result-item dxd-list-item-back-color dxd-back-highlighted" data-bind="dxclick: function() { $parent.goToResult($data); }">
                ...
                <div class="dxrd-preview-search-tab-item-info" data-bind="text: $root.dx.Reporting.Viewer.Internal.formatSearchResult($data)"></div>
            </div>
            <!-- /ko -->
...
<script type="text/html" id="dxrv-daterange-editor">
...
<script type="text/html" id="dxrd-multivalue">
    ...
    <div data-bind="dxTagBox: $parent.getOptions({ dataSource: $data.dataSource, searchEnabled: true, searchExpr: $data.searchExpr || ['displayValue'], value: $data.value,
         ...
         placeholder: $root.dx.Analytics.Internal.selectPlaceholder(), maxDisplayedTags: $data.maxDisplayedTags, dropDownOptions: { container: $root.getPopupContainer($element) } }), 
...
<script type="text/html" id="dxcd-collection-lookup-header">
    <div data-bind="dxSelectBox: { items: array, displayExpr: 'name', value: selectedItem, disabled: disabled,  placeholder: $root.dx.Analytics.Internal.selectPlaceholder(), noDataText: $root.dx.Analytics.Internal.noDataText(), dropDownOptions: { container: $root.getPopupContainer($element) } }"></div>
</script>
    ...
    <div class="dxcd-summary-function-content">
        ...
        <div class="dx-field dxd-back-primary">
            ...
            <div class="dx-field-value">
                <div data-bind="dxSelectBox: { value: functionName, dataSource: $parent.availableItems() ,acceptCustomValue: true, disabled: $parent.disabled(), placeholder: $root.dx.Analytics.Internal.selectPlaceholder(), dropDownOptions: { container: $root.getPopupContainer($element) } }"></div>
            </div>
        </div>
        <!-- ko foreach: args -->
...
<script type="text/html" id="dxrd-vertical-band-selection">
...
<script type="text/html" id="dxrd-vertical-band">
...
<script type="text/html" id="dxrd-pivotGridFields">
    <div class="dxrd-editor" data-bind="visible: visible">
        <div data-bind="dxCollectionEditor: { values: value, addHandler: $root.dx.Reporting.Designer.Controls.PivotGrid.PivotGridFieldViewModel.createNew(_model), displayName: $root.getLocalization(displayName), level: level, info: info }">
        </div>
    </div>
</script>
<script type="text/html" id="dxrd-pivot-sortBySummaryInfo-conditions">
    <div class="dx-editor" data-bind="visible: visible">
        <div data-bind="dxCollectionEditor: {
                 ...
                 level: level,
                 info: info,
                 addHandler: function(){ return $root.dx.Reporting.Designer.Controls.PivotGrid.SortBySummaryInfoCondition.createNew($parents[1].value()) }
             }">
        </div>
    </div>
</script>
                        ...
                        <div class="dxrd-ghost-container" data-bind="styleunit: { 'width': pageWidthWithoutMargins, 'height': minHeight }">
                            ...
                            <div class="dxrd-bands-content dxrd-selection" data-bind="styleunit: { 'width': pageWidthWithoutMargins }">
                                <div class="dxrd-bands-content-offset">
                                    ...
                                    <!-- ko foreach: crossBandControls -->
                                    <!-- ko if: visible -->
                                    <div class="dxrd-cross-band" data-bind="visible: isSelected() && !$root.dx.Analytics.Internal.DragDropHandler.started(), css: {'dxrd-selected': selected, 'dxrd-focused': focused, 'dxrd-intersect': isIntersect, 'dxrd-locked': locked }, resizable: $root.resizeHandler, draggable: $root.dragHandler, styleunit: position, trackCursor: underCursor">
                                    </div>
                                    <!-- /ko -->
                                    <!-- /ko -->
...
<div class="dxrd-table-control" data-bind="style: { visibility: (selected() || focused()) ? 'inherit' : 'hidden'}, css: { 'dxrd-selected': selected, 'dxrd-focused': focused, 'dxrd-intersect': isIntersect, 'dxrd-locked': locked }, resizable: $root.resizeHandler, draggable: $root.dragHandler, styleunit: position">
    ...
    <div class="dxrd-table-column-selection dxrd-table-column-selection-top" data-bind="click: function(_, e) { !$root.selection.disabled() && selectColumn($root.selection); e.stopPropagation(); }, visible: !$root.dx.Analytics.Internal.DragDropHandler.started(), styleunit: { 'left': position.left, 'width': position.width }"></div>
    <!-- /ko -->
    <!-- ko foreach: rows -->
    <div class="dxrd-table-row-control" data-bind="styleunit: { 'top': position.top, 'height': position.height }">
        <div class="dxrd-table-row-selection dxrd-table-row-selection-left" data-bind="trackCursor: underCursor, visible: !$root.dx.Analytics.Internal.DragDropHandler.started()"></div>
        <!-- ko foreach: cells -->
        ...
        <!-- /ko -->
        <div class="dxrd-table-row-selection dxrd-table-row-selection-right" style="visibility: visible" data-bind="trackCursor: underCursor, visible: !$root.dx.Analytics.Internal.DragDropHandler.started()"></div>
    </div>
    <!-- /ko -->
    <!-- ko foreach: rows()[rows().length-1].cells -->
    <div class="dxrd-table-column-selection dxrd-table-column-selection-bottom" data-bind="click: function(_, e) { !$root.selection.disabled() && selectColumn($root.selection); e.stopPropagation(); },visible: !$root.dx.Analytics.Internal.DragDropHandler.started(), styleunit: { 'left': position.left, 'width': position.width }"></div>
    <!-- /ko -->
    <!-- /ko -->
</div>
...
<div class="dxrd-table-control" data-bind="visible: isSelected() && !(selected() || focused()), styleunit: position">
    ...
    <div class="dxrd-table-row-control" data-bind="visible: isSelected(), css: { 'dxrd-selected': selected, 'dxrd-focused': focused, 'dxrd-locked': locked }, resizable: { starting: $root.resizeHandler.starting, stopped: $root.resizeHandler.stopped, handles: 'n,s', disabled: !(selected() || focused()), zoom: $root.surface().zoom }, styleunit: { 'top': position.top, 'height': position.height }">
        <div class="dxd-border-accented dxrd-control-border-box"></div>
        <div class="dxrd-table-row-selection dxrd-table-row-selection-left" data-bind="visible: !$root.dx.Analytics.Internal.DragDropHandler.started(), trackCursor: underCursor"></div>
        <!-- ko foreach: cells -->
        ...
        <!-- /ko -->
        <div class="dxrd-table-row-selection dxrd-table-row-selection-right" data-bind="visible: !$root.dx.Analytics.Internal.DragDropHandler.started(), trackCursor: underCursor"></div>
    </div>
    ...
    <!-- /ko -->
    <!-- ko foreach: rows()[rows().length-1].cells -->
    <div class="dxrd-table-column-selection dxrd-table-column-selection-bottom" data-bind="visible: !$root.dx.Analytics.Internal.DragDropHandler.started(),click: function(_, e) { !$root.selection.disabled() && selectColumn($root.selection); e.stopPropagation(); }, styleunit: { 'left': position.left, 'width': position.width }"></div>
    <!-- /ko -->
    <!-- /ko -->
</div>
                    ...
                    <div class="dx-property-grid-selected-component">
                        <div class="dxrd-properties-focused-item" style="margin:0" data-bind="dxSelectBox: {
                            ...
                            displayExpr: function(value) {
                                 ...
                                 return $root.dx.Analytics.Internal.getControlFullName(showValue)
                                 },
...
<div class="dxrd-fieldslist-wrapper" data-bind="visible: active() && visible()" style="height: 100%; overflow:hidden">
    ...
    <div class="dxrd-right-panel-header dxd-text-primary">
        ...
        <div class="dxrd-add-dataSource-popup-content" data-bind="dxPopover:{ width: 200, visible: popoverVisible, target: '#btn-add-dataSouce', container: $root.getPopupContainer($element), title:$root.getLocalization('Add Data Source', 'ReportStringId.UD_Title_FieldList_AddNewDataSourceText') + ':' }">
    ...
    <div class="dxrd-localization-editor dx-editors" data-bind="css: { 'dx-rtl': $root.rtl, 'dx-ltr': !$root.rtl }, styleunit: { width: width }">
        <div class="dxrd-left-localization-panel dx-editors dxd-text-primary dxd-back-primary" data-bind="resizable: getResizableOptions($element, '0px', 500, $root.rtl ? 'Left': 'Right', 'Right', width)">
            ...
            <div class="dxrd-localization-panel-content">
                ...
                <div data-bind="dxList: { dataSource: localizationItems, selectionMode: 'single', height: 'calc(100% - 59px)', onSelectionChanged: onSelectionChanged, focusStateEnabled: false, activeStateEnabled: false, pageLoadMode: 'scrollBottom', noDataText: $root.dx.Analytics.Internal.noDataText() }">
...
<script type="text/html" id="dxrd-reportexplorerwrapper">
    <div class="dxrd-fieldslist-wrapper" data-bind="visible: active() && visible()" style="height: 100%; overflow:hidden">
        ...
        <div class="dxrd-right-panel-body" data-bind="dxScrollView: { showScrollbar: 'onHover', scrollByContent: false, bounceEnabled: false, useNative: false, scrollByThumb: true }, dxAutoScrolling: { active: $root.dx.Analytics.Internal.DragDropHandler.started }">
...
<script type="text/html" id="dxrd-parameters-dialog">
...
<script type="text/html" id="dxrd-lookUpValues-editing">
    <div class="dxrd-editor dxrd-parameter-group-editor dxrd-parameters-group-offset" data-bind="visible: visible">
        <div class="dxrd-lookup-values-collectioneditor" data-bind="dxCollectionEditor: {
             values: value,
             addHandler: $root.dx.Reporting.Designer.Data.LookUpValue.createNew,
             level: level,
             displayName: $root.getLocalization(displayName),
             info: info,
             collapsed: false,
...
<script type="text/html" id="dxrd-report-dialog-template">
    <div class="dxrd-reportdialog dx-editors dx-widget" data-bind="dxPopup: {
        ...
        <!-- /ko -->
        <!-- ko if: disabled -->
        <div data-bind="dxLoadPanel: { visible:true }"></div>
        <!-- /ko -->
    </div>
</script>
...
<script type="text/html" id="dxrd-menubutton-template">
...
<script type="text/html" id="dxrd-reportSourceUrl">
    <div data-bind="dxSelectBox: { items: getItems($root.reportUrls, $root.navigateByReports.currentTab), searchEnabled: true, value: value, disabled: disabled, valueExpr: 'Key', displayExpr: 'Value', dropDownOptions: { container: $root.getPopupContainer($element) } }"></div>
</script>
        ...
        <div data-bind="dxCollectionEditor: options">
            <div data-bind="dxdAccordion: { collapsed: collapsed }">
                ...
                <div class="dx-accordion-content dxd-back-primary">
                    <div data-bind="dxPropertyGrid: { target: value, editorsInfo: { editors: $root.dx.Reporting.Designer.Controls.Metadata.formattingRuleSerializationsInfo }, level: editor.level + 1, parentDisabled: editor.disabled }"></div>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/html" id="dxrd-style">
    <div data-bind="dxSelectBox: new $root.dx.Reporting.Designer.Widgets.StylesEditorHeaderModel(value, $root.styles(), disabled, $root.getPopupContainer($element))"></div>
</script>
...
<script type="text/html" id="dxrd-scriptsbox">
    <div data-bind="dxEventDropDownEditor: { items: $root.events, value: value, editEnabled: true, disabled: disabled, secondAction: function() { $root.gotoEvent && $root.gotoEvent($data.value(), name, $parents[1]._model && $parents[1]._model()); }, placeholder: $root.dx.Analytics.Internal.selectPlaceholder(), noDataText: $root.dx.Analytics.Internal.noDataText(), dropDownOptions: { container: $root.getPopupContainer($element) } }"></div>
</script>
...
<script type="text/html" id="dxrd-collection-item-group">
    ...
    itemsProvider: $root.dataBindingsProvider(),
    treeListController: new $root.dx.Analytics.Widgets.Internal.TreeListController(),
...
<script type="text/html" id="dxrd-lookUpValues">
    <div class="dxrd-editor" data-bind="visible: visible">
        <div data-bind="dxCollectionEditor: { values: value, addHandler: $root.dx.Reporting.Designer.Data.LookUpValue.createNew, undoEngine: $root.undoEngine, level: level, displayName: $root.getLocalization(displayName), info: info }">
...
<script type="text/html" id="dxrd-levelCollection">
    <div class="dxrd-editor" data-bind="visible: visible">
        <div data-bind="dxCollectionEditor: { values: value, displayName: $root.getLocalization(displayName), level: level, info: info, addHandler: function() { return $root.dx.Reporting.Designer.Controls.TableOfContentsLevel.createNew(_model()); } }">
        </div>
    </div>
</script>
...
<script type="text/html" id="dxrd-collectionItemWithAccordion">
    <div class="dxrd-accordion-collection-item" data-bind="dxdAccordion: { collapsed: collapsed }">
        <div class="dxrd-group-header dx-accordion-header dxd-text-primary">
            <div data-bind="styleunit: {'paddingLeft': $parents[1].padding + $root.dx.Analytics.Widgets.Internal.propertiesGridEditorsPaddingLeft }">
            ...
            <div class="dxrd-wizard-customizelabel-head-props">
                <div class="dxrd-wizard-customizelabel-select-papersize">
                    ...
                    <div data-bind="dxSelectBox: { items: _labelData.paperKinds, displayExpr: 'name', value: _selectedPaperSize, itemTemplate: 'PaperSizeText', dropDownOptions: { container: $root.getPopupContainer($element) }, 
                        ...
                        }}, attr: { title: _selectedPaperSize().name + ' - ' + $root.dx.Reporting.Designer.Wizard.CustomizeLabelPage._getPageSizeText(_selectedPaperSize().width, _selectedPaperSize().height, _selectedPaperSize().unit)}">
                        <div data-options="dxTemplate: { name: 'PaperSizeText' }" class="dxrd-wizard-customizelabel-select-customtemplate">
                            <p class="dxrd-wizard-customizelabel-select-template">
                                ...
                                <span data-bind="text: $root.dx.Reporting.Designer.Wizard.CustomizeLabelPage._getPageSizeText(width, height, unit)"></span>
                            </p>
                        </div>
                    </div>
                </div>
...
<div class="dxrd-wizard-page dxrd-wizard-groups-page">
    <div class="dxrd-wizard-left-panel">
        ...
        <div class="dx-default-border-style dxd-border-secondary">
            <div class="dxrd-wizard-list" data-bind="dxList: { dataSource: fields.items, selectedItems: fields.activeItemArray, height: 257, selectionMode: 'single', activeStateEnabled: false, onItemClick: fieldClick, noDataText: $root.dx.Analytics.Internal.noDataText() }">
    ...
    <div class="dxrd-wizard-right-panel">
        ...
        <div class="dx-default-border-style dxd-border-secondary">
            <div class="dxrd-wizard-list" data-bind="dxList: { items: groups.items, height: 257, selectionMode: 'single', selectedItems: groups.activeItemArray, activeStateEnabled: false, onItemClick: groupClick, noDataText: $root.dx.Analytics.Internal.noDataText() }">
    ...
    <div class="dxrd-wizard-masterdetail-groups-page-content">
        <div class="dxrd-wizard-left-panel">
            ...
            <div class="dx-default-border-style dxd-border-secondary dxrd-wizard-panel-content">
                ...
                <div class="dxrd-wizard-list" data-bind="dxList: { items: _currentFields().items, selectedItems: _currentFields().activeItemArray, height: '100%', selectionMode: 'single', activeStateEnabled: false, onItemClick: _fieldClick, noDataText: $root.dx.Analytics.Internal.noDataText() }">
        ...
        <div class="dxrd-wizard-right-panel">
            ...
            <div class="dx-default-border-style dxd-border-secondary dxrd-wizard-panel-content">
                ...
                <div class="dxrd-wizard-list" data-bind="dxList: { items: _currentGroups().items, height: '100%', selectionMode: 'single', selectedItems: _currentGroups().activeItemArray, activeStateEnabled: false, onItemClick: _groupClick, noDataText: $root.dx.Analytics.Internal.noDataText() }">
                        ...
                        <div class="dxrd-wizard-summary-infos dxd-border-secondary">
                            <div class="dxrd-wizard-summary-infos-fields dxd-wizard-title-back-color dxd-back-secondary dxd-border-secondary">
                                <div data-bind="dxFieldListPicker: {
                                     ...
                                     value: selectedPath,
                                     displayValue: displayName,
                                     placeholder: $root.dx.Analytics.Internal.selectPlaceholder()
                                 }">
                                </div>
                            </div>
        ...
        <div class="dxrd-wizard-list-container">
            <div class="dxrd-wizard-list dx-default-border-style dxd-border-secondary" data-bind="dxScrollView: { showScrollbar: 'onHover', height: '100%' }">
                ...
                <div data-bind="foreach: _summaryInfos">
                    <div class="dxrd-wizard-summary-infos dxd-border-secondary">
                        <div class="dxrd-wizard-summary-infos-fields dxd-wizard-title-back-color dxd-back-secondary dxd-border-secondary">
                            <div data-bind="dxSelectBox: { dataSource: $parent._displayedFields[$parent._currentPath()], itemTemplate: 'visibleItems', displayExpr: 'displayName', value: field, placeholder: $root.dx.Analytics.Internal.selectPlaceholder(), dropDownOptions: { container: $root.getPopupContainer($element) } }">
...
<script type='text/html' id='dxrd-richedit-content'>
