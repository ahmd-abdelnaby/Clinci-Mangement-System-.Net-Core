...
DevExpress.Analytics.Widgets.Internal.SvgTemplatesEngine.addTemplates({
    ...
    'dxrd-svg-actions-reset': '<svg data-bind="svgAttrs" viewBox="0 0 12 12"><path class="dxd-icon-fill" d="M6 1c-1.4 0-2.6.6-3.5 1.5L1 1v4h4L3.9 3.9C4.4 3.3 5.2 3 6 3c1.7 0 3 1.3 3 3S7.7 9 6 9 3 7.7 3 6H1c0 2.8 2.2 5 5 5s5-2.2 5-5-2.2-5-5-5z"/></svg>',
...
(function (DevExpress) {
    ...
    (function (Reporting) {
        ...
        (function (Metadata) {
            ...
            Metadata.defaultCulture = "Default";
            Metadata.availableCultures = ko.observable((_a = {},
                _a[Metadata.defaultCulture] = "(Default)",
                _a));
            ...
            EventGenerator.generateCustomizeLocalizationCallback = function (fireEvent) {
                return function (localizationCallbacks) {
                    fireEvent("CustomizeLocalization", {
                        ...
                        SetAvailableCultures: function (availableCultures) {
                            var newCultures = {};
                            var cultures = DevExpress.Reporting.Metadata.availableCultures;
                            newCultures[DevExpress.Reporting.Metadata.defaultCulture] = cultures()[DevExpress.Reporting.Metadata.defaultCulture];
                            DevExpress.Analytics.Internal.extend(newCultures, availableCultures);
            ...
            var EditingFieldExtensions = (function () {
                ...
                EditingFieldExtensions.prototype.categories = function (excludeCategories) {
                    ...
                    Object.keys(this._editors).forEach(function (p) {
                        var category = _this_1._editors[p].category;
                ...
                EditingFieldExtensions.prototype.editorsByCategories = function (categories) {
                    ...
                    var editors = [];
                    Object.keys(this._editors).forEach(function (p) {
                        if (categories.indexOf(_this_1._editors[p].category) != -1) {
                            editors.push(_this_1._editors[p]);
                        }
                    });
                    return editors;
                };
            ...
            var Locker = (function () {
                function Locker() {
                    ...
                    this.lock = function (action) {
                        if (!_this_1.isUpdate) {
                            _this_1.isUpdate = true;
                            action();
                            _this_1.isUpdate = false;
                        }
                    };
                    this.isUpdate = false;
                }
        ...
        (function (Export) {
            ...
            (function (Metadata) {
                ...
                Metadata.allowURLsWithJSContent = { propertyName: "allowURLsWithJSContent", modelName: "@AllowURLsWithJSContent", displayName: "Allow URLs with JS Content", localizationId: "DevExpress.XtraPrinting.HtmlExportOptionsBase.AllowURLsWithJSContent", editor: DevExpress.Analytics.Widgets.editorTemplates.bool, from: DevExpress.Analytics.Utils.parseBool, defaultVal: false };
        ...
        (function (Viewer) {
            ...
            (function (Internal) {
                ...
                var PreviewRequestWrapper = (function () {
                    ...
                    PreviewRequestWrapper.prototype.startBuildRequest = function (shouldIgnoreError) {
                        ...
                        return DevExpress.Analytics.Internal.ajax({
                            ...
                            processErrorCallback: PreviewRequestWrapper.getProcessErrorCallback(this._reportPreview, DevExpress.Analytics.Utils.getLocalization("Cannot create a document for the current report", "ASPxReportsStringId.WebDocumentViewer_DocumentCreationError"))
                        });
                    };
                ...
                Internal.stringToPosition = stringToPosition;
                ...
                Internal.getUpdatePreviewElementPositionCallback = getUpdatePreviewElementPositionCallback;
                ...
                function updatePreviewContentSize(previewSize, root, rtl) {
                    ...
                    return function (tabPanelPosition) {
                        ...
                        var sizeFactor = DevExpress.Analytics.Internal.getSizeFactor($_root.outerWidth());
                ...
                var PreviewPage = (function (_super) {
                    ...
                    function PreviewPage(preview, pageIndex, processClick, loading) {
                        ...
                        _this_1.imageSrc = ko.observable("").extend({ rateLimit: { timeout: 100, method: "notifyWhenChangesStop" } });
                        ...
                        _this_1._disposables.push(_this_1.imageSrc.subscribe(function (newVal) {
                            ...
                            Internal.PreviewRequestWrapper.getPage(newVal, ignoreError)
                                .done(function (response) {
                                _this_1.imageHeight(response.height);
                                _this_1.imageWidth(response.width);
                                _this_1.currentScaleFactor(_this_1._currentScaleFactor);
                        ...
                        _this_1._disposables.push(_this_1.isClientVisible.subscribe(function (newVal) {
                            if (newVal) {
                        ...
                        _this_1.resetBrickRecusive = function (brick) {
                            if (brick && brick.active) {
                                brick.active(false);
                                if (brick.bricks) {
                                    brick.bricks.forEach(function (childBrick) { _this_1.resetBrickRecusive(childBrick); });
                                }
                            }
                        };
                ...
                Internal.PreviewDisposableModel = PreviewDisposableModel;
                ...
                function getUpdateProgressBarCallback(progressBarSettings, designerModel, reportPreview, rootElement, $window) {
                    ...
                    var position = Internal.stringToPosition(progressBarSettings && progressBarSettings.position);
                    reportPreview.progressBar.setPosition(position);
                    if (!keepProgressBarVisible)
                        return $.noop;
                    var $root = $(rootElement);
                    var $progress = $root.find(".dxrd-preview-progress");
                    var updateProgressBarPosition = Internal.getUpdatePreviewElementPositionCallback($progress, $root, $window, ".dxrd-preview-progress", position);
                ...
                Internal.getUpdateProgressBarCallback = getUpdateProgressBarCallback;
                function createDesktopPreview(element, callbacks, parametersInfo, handlerUri, previewVisible, applyBindings, allowURLsWithJSContent, rtl, tabPanelSettings, progressBarSettings) {
                    ...
                    var fullscreenEnabled = Reporting.Internal.createFullscreenComputed(element, reportPreview);
                    var previewActions = new Internal.PreviewActions(reportPreview);
                    var designPreviewActions = new Internal.PreviewDesignerActions(reportPreview, fullscreenEnabled);
                    ...
                    var $window = $(window);
                    var updateProgressPosition = Internal.getUpdateProgressBarCallback(progressBarSettings, designerModel, reportPreview, element, $window);
                ...
                function _createPreview(element, callbacks, localization, parametersInfo, handlerUri, previewVisible, rtl, isMobile, mobileModeSettings, applyBindings, allowURLsWithJSContent, remoteSettings, tabPanelSettings, progressBarSettings) {
                    ...
                    var designerModel;
                    if (isMobile) {
                        designerModel = DevExpress.Reporting.Viewer.Mobile.Internal.createMobilePreview(element, callbacks, parametersInfo, handlerUri, previewVisible, applyBindings, allowURLsWithJSContent, mobileModeSettings, progressBarSettings);
                    }
                    else {
            ...
            (function (Parameters) {
                    ...
                    ParameterHelper.prototype.addShowCleanButton = function (info, parameter) {
                        ...
                        info.editorOptions.placeholder = ko.computed(function () {
                            if (ko.unwrap(parameter.allowNull))
                                return _this_1.getUnspecifiedDisplayText();
                            return ko.unwrap(parameter.isMultiValue) ? DevExpress.Analytics.Internal.selectPlaceholder() : "";
                        });
                    };
                ...
                var PreviewParameter = (function (_super) {
                    ...
                    function PreviewParameter(parameterInfo, parameterHelper) {
                        ...
                        _this_1.isRange = parameterInfo.Value && parameterInfo.Value.Start !== undefined && parameterInfo.Value.End !== undefined;
                        ...
                        _this_1.selectAllValues = parameterInfo.SelectAllValues;
                ...
                var PreviewParametersViewModel = (function (_super) {
                    ...
                    function PreviewParametersViewModel(reportPreview, parameterHelper) {
                        ...
                        _this_1.restore = function () {
                            if (_this_1.parametersLoading()) {
                                return;
                            }
                            try {
                                _this_1.parametersLoading(true);
                                _this_1._parameters.forEach(function (parameter) {
                                ...
                                _this_1.parameterHelper.callbacks && _this_1.parameterHelper.callbacks.parametersReset && _this_1.parameterHelper.callbacks.parametersReset(_this_1, _this_1._parameters);
                                _this_1.parametersLoading(false);
                            }
                        };
                ...
                var PreviewParameterHelper = (function (_super) {
                    ...
                    PreviewParameterHelper.prototype.getRangeEditor = function () {
                        return Widgets.editorTemplates.rangeEditor;
                    };
            ...
            (function (Internal) {
                ...
                var DocumentMapModel = (function (_super) {
                    ...
                    function DocumentMapModel(reportPreview) {
                        ...
                        _this_1._disposables.push({ dispose: function () { return delete reportPreview.brickClickDocumentMapHandler; } });
            ...
            (function (Widgets) {
                ...
                (function (Internal) {
                    ...
                    var Painter = (function (_super) {
                        ...
                        function Painter(options) {
                            ...
                            _this_1.format(options.imageType);
                        ...
                        Painter.prototype.imageFormatByType = function (imageType) {
                            return imageType === Editing.ImageEditingFieldViewModel.__DefaultImageType ? "png" : imageType;
                        };
                    ...
                    var PopupComponentBase = (function (_super) {
                        ...
                        function PopupComponentBase() {
                            ...
                            _this_1._component = ko.observable();
                            _this_1.onContentReady = function (e) {
                                _this_1._component(e.component);
                            };
                            _this_1.closeOnOutsideClick = function (e) {
                                var component = _this_1.getComponent();
                    ...
                    Internal.PopupComponentBase = PopupComponentBase;
                    var PictureEditorToolbarItemWithPopup = (function (_super) {
                        ...
                        function PictureEditorToolbarItemWithPopup(options) {
                            ...
                            if (options.templateOptions) {
                                ...
                                _this_1._popup = new PopupComponentBase();
                                _this_1.templateOptions.onContentReady = _this_1._popup.onContentReady;
                                _this_1.templateOptions.closeOnOutsideClick = _this_1._popup.closeOnOutsideClick;
                        ...
                        PictureEditorActionProvider.prototype.createImagePickerAction = function (images, filterEnabled, action) {
                            ...
                            var popupOptions = this._initPopupOptions({
                                ...
                                contentData: {
                                    ...
                                    filter: filter,
                                    searchPlaceholder: function () { return DevExpress.Analytics.Internal.searchPlaceholder(); },
                    ...
                    var PictureEditorModel = (function (_super) {
                        ...
                        function PictureEditorModel(options, element) {
                            ...
                            _this_1._initialImageType = ko.unwrap(options.imageType) || "png";
                            ...
                            var painterOptions = {
                                ...
                                imageType: _this_1._initialImageType,
                        ...
                        PictureEditorModel.prototype._initActions = function (customizeActionsCallback) {
                            ...
                            if (!!this._initialImage) {
                                this.actions.push(this.actionsProvider.createResetItem(function () {
                                    _this_1.painter.reset(_this_1._initialImage, _this_1._initialAlignment, _this_1._initialSizeMode, _this_1._initialImageType);
                                }));
                            }
                        ...
                        PictureEditorModel.prototype._loadImage = function (event) {
                            ...
                            DevExpress.Analytics.Internal.uploadFile({
                                accept: "image/*"
                            }).done(function (result) {
                                _this_1.painter.format(result.format);
                                _this_1.painter.image(result.content);
                        ...
                        PictureEditorModel.prototype._addEvents = function () {
                            ...
                            this._pointerUpHandler = function (e) {
                                ...
                                var isEditorContainer = _this_1.$element.is(e.target) || _this_1.$element.has(e.target).length > 0
                                    ...
                                    || (e.target && e.target.className && e.target.className.indexOf && e.target.className.indexOf(_this_1.GESTURE_COVER_CLASS) !== -1);
                        ...
                        PictureEditorModel.prototype.getCurrentOptions = function () {
                            ...
                            return {
                                ...
                                imageType: this.painter.hasSignature() ? Editing.ImageEditingFieldViewModel.__DefaultImageType : this.painter.format(),
                ...
                function createDateRangeEditorItems() {
                    var getLocalizedString = DevExpress.Analytics.Utils.getLocalization;
                    return [].concat([
                        {
                            displayName: getLocalizedString("Today", "PreviewStringId.DateRangeParameterEditor_Today"), range: function () { return [
                                CSDateTime.today.date,
                                CSDateTime.today.date
                            ]; }
                        },
                        {
                            displayName: getLocalizedString("Yesterday", "PreviewStringId.DateRangeParameterEditor_Yesterday"), range: function () { return [
                                CSDateTime.today.addDays(-1).date,
                                CSDateTime.today.addDays(-1).date
                            ]; }
                        },
                        {
                            displayName: getLocalizedString("Current Week", "PreviewStringId.DateRangeParameterEditor_CurrentWeek"), range: function () { return [
                                CSDateTime.today.addDays(-CSDateTime.today.day).date,
                                CSDateTime.today.addDays(-CSDateTime.today.day).addDays(6).date
                            ]; }
                        },
                        {
                            displayName: getLocalizedString("Last Week", "PreviewStringId.DateRangeParameterEditor_LastWeek"), range: function () { return [
                                CSDateTime.today.addDays(-7).date,
                                CSDateTime.today.date
                            ]; }
                        },
                        {
                            displayName: getLocalizedString("Previous Week", "PreviewStringId.DateRangeParameterEditor_PreviousWeek"), range: function () { return [
                                CSDateTime.today.addDays(-CSDateTime.today.day - 7).date,
                                CSDateTime.today.addDays(-CSDateTime.today.day - 1).date
                            ]; }
                        },
                        {
                            displayName: getLocalizedString("Current Month", "PreviewStringId.DateRangeParameterEditor_CurrentMonth"), range: function () { return [
                                new Date(CSDateTime.today.year, CSDateTime.today.month, 1),
                                new Date(CSDateTime.today.year, CSDateTime.today.month + 1, 0),
                            ]; }
                        },
                        {
                            displayName: getLocalizedString("Last Month", "PreviewStringId.DateRangeParameterEditor_LastMonth"), range: function () { return [
                                CSDateTime.today.addMonths(-1).date,
                                CSDateTime.today.date
                            ]; }
                        },
                        {
                            displayName: getLocalizedString("Previous Month", "PreviewStringId.DateRangeParameterEditor_PreviousMonth"), range: function () { return [
                                new Date(CSDateTime.today.year, CSDateTime.today.month - 1, 1),
                                new Date(CSDateTime.today.year, CSDateTime.today.month, 0),
                            ]; }
                        },
                        {
                            displayName: getLocalizedString("Current Quarter", "PreviewStringId.DateRangeParameterEditor_CurrentQuarter"), range: function () { return [
                                CSDateTime.today.addMonths(-CSDateTime.today.month % 3).date,
                                CSDateTime.today.addMonths(-CSDateTime.today.month % 3 + 3).date,
                            ]; }
                        },
                        {
                            displayName: getLocalizedString("Previous Quarter", "PreviewStringId.DateRangeParameterEditor_PreviousQuarter"), range: function () { return [
                                CSDateTime.today.addMonths(-CSDateTime.today.month % 3 - 3).date,
                                CSDateTime.today.addMonths(-CSDateTime.today.month % 3).date,
                            ]; }
                        },
                        {
                            displayName: getLocalizedString("Current Year", "PreviewStringId.DateRangeParameterEditor_CurrentYear"), range: function () { return [
                                new Date(CSDateTime.today.year, 0, 1),
                                new Date(CSDateTime.today.year, 11, 31),
                            ]; }
                        },
                        {
                            displayName: getLocalizedString("Last Year", "PreviewStringId.DateRangeParameterEditor_LastYear"), range: function () { return [
                                CSDateTime.today.addYears(-1).date,
                                CSDateTime.today.date
                            ]; }
                        },
                        {
                            displayName: getLocalizedString("Previous Year", "PreviewStringId.DateRangeParameterEditor_PreviousYear"), range: function () { return [
                                new Date(CSDateTime.today.year - 1, 0, 1),
                                new Date(CSDateTime.today.year - 1, 11, 31),
                            ]; }
                        },
                    ], DateRangeEditor.customRanges);
                }
                var DateRangeEditor = (function (_super) {
                    __extends(DateRangeEditor, _super);
                    function DateRangeEditor(_options) {
                        var _this_1 = _super.call(this) || this;
                        _this_1._options = _options;
                        _this_1._locker = new DevExpress.Reporting.Internal.Locker();
                        _this_1._popupVisible = ko.observable(false);
                        _this_1.popupTemplate = "dxrv-daterange-editor-popup";
                        _this_1.items = [];
                        _this_1.startDate = ko.observable(new Date(new Date().setHours(0, 0, 0, 0)));
                        _this_1.endDate = ko.observable(new Date(new Date().setHours(0, 0, 0, 0)));
                        _this_1._disposables.push(_options.value.subscribe(function (newVal) { return _this_1.applyDate(newVal); }), _this_1._displayText = ko.computed(function () { return _this_1._getStringValue([_this_1.startDate(), _this_1.endDate()]); }), _this_1.startDate.subscribe(function () { return _this_1.applyValue(_this_1.startDate() > _this_1.endDate()); }), _this_1.endDate.subscribe(function () { return _this_1.applyValue(); }));
                        _this_1.applyDate(_this_1._options.value());
                        _this_1.items = createDateRangeEditorItems();
                        if (_options.isMobile) {
                            _this_1.popupTemplate = "dxrd-menu-parameters-content";
                            _this_1.popupModel = new Mobile.Internal.DateRangeParemeterPopupModel(_this_1);
                        }
                        else {
                            _this_1.popupModel = _this_1;
                        }
                        return _this_1;
                    }
                    DateRangeEditor.prototype._getStringValue = function (range) {
                        return range.map(function (x) { return DevExpress.Analytics.Internal.formatDate(x); }).join(' - ');
                    };
                    ...
                    DateRangeEditor.prototype._createTemplateData = function (value, min) {
                        ...
                        return {
                            value: value,
                            min: min,
                            inRange: function (date) { return _this_1.inRange(date); }
                        };
                    };
                    DateRangeEditor.prototype.applyDate = function (range, force) {
                        ...
                        this._locker.lock(function () {
                            if (range[1] < _this_1.startDate()) {
                                _this_1.startDate(range[0]);
                                _this_1.endDate(range[1]);
                            }
                            else {
                                _this_1.endDate(range[1]);
                                _this_1.startDate(range[0]);
                    ...
                    DateRangeEditor.prototype.inRange = function (date) {
                        return date <= new Date(this.endDate().setHours(0, 0, 0, 0)) &&
                            date >= new Date(this.startDate().setHours(0, 0, 0, 0));
                    };
                    DateRangeEditor.prototype.applyValue = function (updateEndDate) {
                        var _this_1 = this;
                        if (updateEndDate === void 0) { updateEndDate = false; }
                        this._locker.lock(function () {
                            updateEndDate && _this_1.endDate(_this_1.startDate());
                            _this_1._options.value(_this_1._toParameterValue());
                        });
                    };
                    DateRangeEditor.customRanges = [];
                    return DateRangeEditor;
                }(DevExpress.Analytics.Utils.Disposable));
                Widgets.DateRangeEditor = DateRangeEditor;
                ko.bindingHandlers["dxrvDateRangeEditor"] = {
                    init: function (element, valueAccessor, bindings, model, bindingContext) {
                        ...
                        $(element).children().remove();
                        var templateHtml = DevExpress.Analytics.Widgets.Internal.getTemplate('dxrv-daterange-editor'), $element = $(element).append(templateHtml);
                        var context = bindingContext.createChildContext(rangeEditor);
                        ko.applyBindingsToDescendants(context, $element.children()[0]);
                        DevExpress.Analytics.Internal.addDisposeCallback(element, function () { return rangeEditor.dispose(); });
                        return { controlsDescendantBindings: true };
                    }
                };
                ...
                var PopupImageEditingFieldViewModel = (function (_super) {
                    ...
                    function PopupImageEditingFieldViewModel() {
                        ...
                        _this_1._resetPictureEditor = function (pictureEditorModel) {
                            pictureEditorModel.reset(_this_1.painterData.imageSource, _this_1.painterData.alignment, _this_1.painterData.sizeMode, _this_1.painterData.imageType);
                            _this_1._resetPainter(pictureEditorModel.painter);
                        };
                        _this_1._resetPainter = function (painter) {
                            painter.imagePainter.format(painter.imageFormatByType(_this_1.getImageType()));
                            painter.imagePainter.sizeMode(_this_1.sizeMode());
                            painter.imagePainter.alignment(_this_1.alignment());
                ...
                (function (Internal) {
                    var MobilePreviewModel = (function (_super) {
                        ...
                        function MobilePreviewModel(options) {
                            var _this_1 = _super.call(this, options) || this;
                            _this_1.slideOptions = options.slideOptions;
                            _this_1.gallery = options.gallery;
                            _this_1.paginator = options.paginator;
                            _this_1.brickEventsDisabled = options.brickEventsDisabled;
                            _this_1.availableFormats = options.availableFormats;
                            _this_1._addDisposable(_this_1.gallery);
                            _this_1._addDisposable(_this_1.paginator);
                            return _this_1;
                        }
                        return MobilePreviewModel;
                    }(Viewer.Internal.PreviewDisposableModel));
                    Internal.MobilePreviewModel = MobilePreviewModel;
                    Internal.editorTemplates = {
                    ...
                    var MobilePreviewParameterHelper = (function (_super) {
                        ...
                        MobilePreviewParameterHelper.prototype.getRangeEditor = function () {
                            return Mobile.Internal.editorTemplates.rangeEditor;
                        };
                        return MobilePreviewParameterHelper;
                    }(Parameters.PreviewParameterHelper));
                    Internal.MobilePreviewParameterHelper = MobilePreviewParameterHelper;
                    ...
                    function createMobilePreview(element, callbacks, parametersInfo, handlerUri, previewVisible, applyBindings, allowURLsWithJSContent, mobileModeSettings, progressBarSettings) {
                        ...
                        var parametersModel = new Viewer.Parameters.PreviewParametersViewModel(reportPreview, new Mobile.Internal.MobilePreviewParameterHelper(parametersInfo && parametersInfo.knownEnums, callbacks));
                        ...
                        var $window = $(window);
                        var updateProgressPosition = Viewer.Internal.getUpdateProgressBarCallback(progressBarSettings, designerModel, reportPreview, element, $window);
                        var updateMobilePreviewActionsPosition_ = Viewer.Internal.getUpdatePreviewElementPositionCallback($actions, $root, $window, ".dxrdp-mobile-actions");
                        var updateSizesCallback = function () {
                ...
                (function (Internal) {
                    var ParametersPopupModelBase = (function (_super) {
                        ...
                        function ParametersPopupModelBase(formModel) {
                            var _this_1 = _super.call(this) || this;
                            _this_1.formModel = formModel;
                            _this_1._submit = function (params) {
                                var result = params.validationGroup && params.validationGroup.validate && params.validationGroup.validate();
                                if (!result || result.isValid) {
                                    _this_1.formModel.submit && _this_1.formModel.submit();
                                    _this_1.visible(false);
                                }
                            };
                            _this_1._reset = function () {
                                _this_1.formModel.reset && _this_1.formModel.reset();
                            };
                            _this_1._cancel = function () {
                                _this_1.formModel.cancel && _this_1.formModel.cancel();
                                _this_1.visible(false);
                            };
                            _this_1.showIcons = ko.observable(false);
                            _this_1.className = "";
                            _this_1.visible = formModel.visible;
                            _this_1.cancelDisabled = ko.observable(false);
                            _this_1.actionButtons = [
                                { className: "dxrdp-parameters-reset", text: DevExpress.Analytics.Utils.getLocalization('Reset', 'ASPxReportsStringId.ParametersPanel_Reset'), action: _this_1._reset, disabled: false, visible: !!formModel.reset, id: "dxrv-mobile-reset" },
                                { className: "dxrdp-parameters-cancel", text: DevExpress.Analytics.Utils.getLocalization('Cancel', 'AnalyticsCoreStringId.SearchDialog_Cancel'), action: _this_1._cancel, disabled: _this_1.cancelDisabled, visible: true, id: "dxrv-mobile-cancel" },
                                { className: "dxrdp-parameters-submit", text: DevExpress.Analytics.Utils.getLocalization('Submit', 'ASPxReportsStringId.ParametersPanel_Submit'), action: _this_1._submit, disabled: false, visible: true, id: "dxrv-mobile-submit" }
                            ];
                            _this_1.actionIcons = [
                                { className: "dxrdp-parameters-reset dxrdp-image-parameters-reset", action: _this_1._reset, disabled: false, visible: !!formModel.reset },
                                { className: "dxrdp-parameters-cancel dxrdp-image-parameters-cancel", action: _this_1._cancel, disabled: _this_1.cancelDisabled, visible: true },
                                { className: "dxrdp-parameters-submit dxrdp-image-parameters-submit", action: _this_1._submit, disabled: false, visible: true }
                            ];
                            return _this_1;
                        }
                    ...
                    Internal.ParametersPopupModelBase = ParametersPopupModelBase;
                    var ParametersPopupModel = (function (_super) {
                        ...
                        function ParametersPopupModel(model, _reportPreview) {
                            var _this_1 = _super.call(this, { visible: model.popupInfo.visible, submit: model.submit, reset: model.restore }) || this;
                            _this_1.model = model;
                            ...
                            _this_1.contentTemplate = "dxrv-preview-parameters-mobile-content";
                            _this_1.title = DevExpress.Analytics.Utils.getLocalization('Parameters', 'DevExpress.XtraReports.UI.XtraReport.Parameters');
                            return _this_1;
                        }
                        ...
                        function DateRangeParemeterPopupModel(model) {
                            var _this_1 = _super.call(this, {
                                visible: model._popupVisible, cancel: function () {
                                    _this_1.model.startDate(_this_1._oldStart);
                                    _this_1.model.endDate(_this_1._oldEnd);
                                    _this_1.model.applyValue();
                                }
                            }) || this;
                            _this_1.model = model;
                            _this_1._dateEditorClassName = "dxrv-daterange-editor-item";
                            _this_1._dateButtonEditorClassName = "dxrv-daterange-editor-button";
                            _this_1.getStringDate = function (value) {
                                return DevExpress.Analytics.Internal.formatDate(value());
                            };
                            _this_1.focusButton = function (e) {
                                var $element = $(e.element);
                                var dateEditor = $element.siblings("." + _this_1._dateEditorClassName);
                                var parent = $element.closest("." + _this_1.className);
                                parent.find("." + _this_1._dateButtonEditorClassName).removeClass("dx-button-default");
                                $element.addClass("dx-button-default");
                                parent.find("." + _this_1._dateEditorClassName).css("zIndex", 1);
                                dateEditor.css("zIndex", 2);
                            };
                            var submitAction = _this_1.actionButtons.filter(function (action) { return action.id == "dxrv-mobile-submit"; })[0];
                            if (submitAction)
                                submitAction.text = DevExpress.Analytics.Utils.getLocalization('OK', DevExpress.Analytics.Internal.StringId.DataAccessBtnOK);
                            _this_1._disposables.push(_this_1.textRangeValue = ko.computed({
                                read: function () { return _this_1.model._displayText(); },
                                write: function (val) { _this_1.model.applyDate(val.range(), true); }
                            }));
                            _this_1._oldStart = _this_1.model.startDate();
                            _this_1._oldEnd = _this_1.model.endDate();
                            _this_1.contentTemplate = "dxrv-preview-date-range-mobile";
                            _this_1.title = DevExpress.Analytics.Utils.getLocalization('Date Range Parameter', 'AnalyticsCoreStringId.Mobile_DateRange_Title');
                            _this_1.className = "dxrv-preview-date-range-mobile-popup";
                            return _this_1;
                        }
                        return DateRangeParemeterPopupModel;
                    }(ParametersPopupModelBase));
                    Internal.DateRangeParemeterPopupModel = DateRangeParemeterPopupModel;
                })(Internal = Mobile.Internal || (Mobile.Internal = {}));
